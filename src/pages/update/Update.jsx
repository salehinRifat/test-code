...
const Update = () => {
    ...
    const { title, image, short_description, long_description, category } = blog
    const handleUpdate = e => {
        ...
        const date = new Date();
        const updateBlog = { title, image, short_description: shortdes, category, long_description: longdes, date }
        axios.put(`http://localhost:5000/blogs/${id}`, updateBlog)
            .then(res => {
        ...
        <div>
            ...
            <div className="isolate bg-white px-6 py-10 sm:py-16 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Update Blog</h2>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div className="mt-2.5">
                                <input type="text" name="title" defaultValue={title} id="title" autoComplete="given-name" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></input>
                            </div>
                        </div>
                        <div>
                            <label htmlFor="imgurl" className="block text-sm font-semibold leading-6 text-gray-900">Image Url</label>
                            <div className="mt-2.5">
                                <input type="url" defaultValue={image} name="imgurl" id="imgurl" autoComplete="family-name" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></input>
                            </div>
                        </div>
                        <div className="sm:col-span-2">
                            <label htmlFor="shortdes" className="block text-sm font-semibold leading-6 text-gray-900">Short Description</label>
                            <div className="mt-2.5">
                                <input type="text" defaultValue={short_description} name="shortdes" id="shortdes" autoComplete="organization" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></input>
                            </div>
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="mt-2.5">
                                <textarea name="longdes" defaultValue={long_description} id="longdes" rows="4" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                            </div>
                        </div>
